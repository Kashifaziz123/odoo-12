...
class DrPrescription(models.Model):
    ...
    od_cyl_distance = fields.Selection([('-3.50', '-3.50'), ('-3.25', '-3.25'), ('-3.00', '-3.00')
                               , ('-2.75', '-2.75'), ('-2.50', '-2.50'), ('-2.25', '-2.25'), ('-2.00', '-2.00')
                               , ('-1.75', '-1.75'), ('-1.50', '-1.50'), ('-1.25', '-1.25'), ('-1.00', '-1.00')
                               , ('0.75', '-0.75'), ('-0.50', '-0.50'), ('-0.25', '-0.25'), ('-0.00', '-0.00')
    ...
    od_cyl_near = fields.Selection([('-3.50', '-3.50'), ('-3.25', '-3.25'), ('-3.00', '-3.00')
                                           , ('-2.75', '-2.75'), ('-2.50', '-2.50'), ('-2.25', '-2.25'),
                                        ('-2.00', '-2.00')
                                           , ('-1.75', '-1.75'), ('-1.50', '-1.50'), ('-1.25', '-1.25'),
                                        ('-1.00', '-1.00')
                                           , ('0.75', '-0.75'), ('-0.50', '-0.50'), ('-0.25', '-0.25'),
                                        ('-0.00', '-0.00')
                                           , ('+0.25', '+0.25'), ('+0.50', '+0.50'), ('+0.25', '+0.25'),
                                        ('+1.00', '+1.00')
                                           , ('+1.25', '+1.25'), ('+1.50', '+1.50'), ('+1.25', '+1.25'),
                                        ('+1.00', '+1.00')
                                           , ('+2.25', '+2.25'), ('+2.50', '+2.50'), ('+2.25', '+2.25'),
                                        ('+2.00', '+2.00')
    ...
    os_cyl_distance = fields.Selection([('-3.50', '-3.50'), ('-3.25', '-3.25'), ('-3.00', '-3.00')
                                , ('-2.75', '-2.75'), ('-2.50', '-2.50'), ('-2.25', '-2.25'), ('-2.00', '-2.00')
                                , ('-1.75', '-1.75'), ('-1.50', '-1.50'), ('-1.25', '-1.25'), ('-1.00', '-1.00')
                                , ('0.75', '-0.75'), ('-0.50', '-0.50'), ('-0.25', '-0.25'), ('-0.00', '-0.00')
                                , ('+0.25', '+0.25'), ('+0.50', '+0.50'), ('+0.75', '+0.75'), ('+1.00', '+1.00')
                                , ('+1.25', '+1.25'), ('+1.50', '+1.50'), ('+1.25', '+1.25'), ('+2.00', '+2.00')
                                , ('+2.25', '+2.25'), ('+2.50', '+2.50'), ('+2.25', '+2.25'), ('+3.00', '+3.00')
                                , ('+3.25', '+3.25'), ('+3.50', '+3.50'), ('+3.75', '+3.75'), ('+4.00', '+4.00'
                                                                                               )], 'Cyll')

    os_cyl_near = fields.Selection([('-3.50', '-3.50'), ('-3.25', '-3.25'), ('-3.00', '-3.00')
                                           , ('-2.75', '-2.75'), ('-2.50', '-2.50'), ('-2.25', '-2.25'),
                                        ('-2.00', '-2.00')
                                           , ('-1.75', '-1.75'), ('-1.50', '-1.50'), ('-1.25', '-1.25'),
                                        ('-1.00', '-1.00')
