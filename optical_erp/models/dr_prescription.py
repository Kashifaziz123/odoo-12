...
class DrPrescription(models.Model):
    ...
    od_sph_distance = fields.Selection(
        [('0','0'), ('-30', '-30'),
         ('-29.75', '-29.75'), ('-29.5', '-29.5'), ('-29.25', '-29.25'), ('-29', '-29'),
         ('-28.75', '-28.75'), ('-28.5', '-28.5'), ('-28.25', '-28.25'), ('-28', '-28'),
         ('-27.75', '-27.75'), ('-27.5', '-27.5'), ('-27.25', '-27.25'), ('-27', '-27'),
         ('-26.75', '-26.75'), ('-26.5', '-26.5'), ('-26.25', '-26.25'), ('-26', '-26'),
         ('-25.75', '-25.75'), ('-25.5', '-25.5'), ('-25.25', '-25.25'), ('-25', '-25'),
         ('-24.75', '-24.75'), ('-24.5', '-24.5'), ('-24.25', '-24.25'), ('-24', '-24'),
         ('-23.75', '-23.75'), ('-23.5', '-23.5'), ('-23.25', '-23.25'), ('-23', '-23'),
         ('-22.75', '-22.75'), ('-22.5', '-22.5'), ('-22.25', '-22.25'), ('-22', '-22'),
         ('-21.75', '-21.75'), ('-21.5', '-21.5'), ('-21.25', '-21.25'), ('-21', '-21'),
         ('-20.75', '-20.75'), ('-20.5', '-20.5'), ('-20.25', '-20.25'), ('-20', '-20'),
         ('-19.75', '-19.75'), ('-19.5', '-19.5'), ('-19.25', '-19.25'), ('-19', '-19'),
         ('-18.75', '-18.75'), ('-18.5', '-18.5'), ('-18.25', '-18.25'), ('-18', '-18'),
         ('-17.75', '-17.75'), ('-17.5', '-17.5'), ('-17.25', '-17.25'), ('-17', '-17'),
         ('-16.75', '-16.75'), ('-16.5', '-16.5'), ('-16.25', '-16.25'), ('-16', '-16'),
         ('-15.75','-15.75'),('-15.5','-15.5'),('-15.25','-15.25'),('-15','-15'),
         ...
         ('+12','+12'), ('+12.25', '+12.25'), ('+12.5', '+12.5'), ('+12.75', '+12.75'),
         ('+13', '+13'), ('+13.25', '+13.25'), ('+13.5', '+13.5'), ('+13.75', '+13.75'),
         ('+14', '+14'), ('+14.25', '+14.25'), ('+14.5', '+14.5'), ('+14.75', '+14.75'),
         ('+15', '+15'), ('+15.25', '+15.25'), ('+15.5', '+15.5'), ('+15.75', '+15.75'),
         ('+16', '+16'), ('+16.25', '+16.25'), ('+16.5', '+16.5'), ('+16.75', '+16.75'),
         ('+17', '+17'), ('+17.25', '+17.25'), ('+17.5', '+17.5'), ('+17.75', '+17.75'),
         ('+18', '+18'), ('+18.25', '+18.25'), ('+18.5', '+18.5'), ('+18.75', '+18.75'),
         ('+19', '+19'), ('+19.25', '+19.25'), ('+19.5', '+19.5'), ('+19.75', '+19.75'),
         ('+20', '+20'), ('+20.25', '+20.25'), ('+20.5', '+20.5'), ('+20.75', '+20.75'),
         ('+21', '+21'), ('+21.25', '+21.25'), ('+21.5', '+21.5'), ('+21.75', '+21.75'),
         ('+22', '+22'), ('+22.25', '+22.25'), ('+22.5', '+22.5'), ('+22.75', '+22.75'),
         ('+23', '+23'), ('+23.25', '+23.25'), ('+23.5', '+23.5'), ('+23.75', '+23.75'),
         ('+24', '+24'), ('+24.25', '+24.25'), ('+24.5', '+24.5'), ('+24.75', '+24.75'),
         ('+25', '+25'), ('+25.25', '+25.25'), ('+25.5', '+25.5'), ('+25.75', '+25.75'),
         ('+26', '+26'), ('+26.25', '+26.25'), ('+26.5', '+26.5'), ('+26.75', '+26.75'),
         ('+27', '+27'), ('+27.25', '+27.25'), ('+27.5', '+27.5'), ('+27.75', '+27.75'),
         ('+28', '+28'), ('+28.25', '+28.25'), ('+28.5', '+28.5'), ('+28.75', '+28.75'),
         ('+29', '+29'), ('+29.25', '+29.25'), ('+29.5', '+29.5'), ('+29.75', '+29.75'),
         ('+30', '+30'),
         ], default='0')
    ...
    od_base_distance = fields.Selection(
        [('0', '0'), ('IN', 'IN'), ('OUT', 'OUT'), ('UP', 'UP'), ('DOWN', 'DOWN'),
         ], 'baser')
